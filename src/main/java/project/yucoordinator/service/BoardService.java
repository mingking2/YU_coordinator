...
import project.yucoordinator.dto.BoardDTO;
import project.yucoordinator.entity.BoardEntity;
import project.yucoordinator.repository.BoardRepository;
...
public class BoardService {
    ...
    public Page<BoardDTO> paging(Pageable pageable) {
        ...
        System.out.println("boardEntities.getContext() = " + boardEntities.getContent()); // 요청 페이지에 해당하는 글
